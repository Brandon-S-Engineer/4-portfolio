...
const Footer = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center z-40'>
      <h1 className='text-[70px] font-semibold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500 py-1 title-text'>Contact</h1>

      <div
        id='footer'
        className='border border-[#7042f861] rounded-full no-rounded-xs w-[90%] px-[85px] decrease-px pb-[1px] mb-4 mx-auto h-full bg-transparent text-gray-200 shadow-lg p-[15px]'>
        <div className='w-full flex flex-col items-center justify-center m-auto'>
          <div className='w-full h-full flex md:flex-col lg:flex-row md:items-center lg:items-start justify-around flex-wrap'>
            {/* Email */}
            <div className='min-w-[200px] h-auto flex flex-col items-center justify-start mb-3 lg:mb-0'>
              <div className='font-bold text-[16px] mb-[-15px] lg:mb-[10px]'>Email</div>
            ...
            {/* Social Media */}
            <div className='min-w-[200px] h-auto flex flex-col items-center justify-start mb-7 lg:mb-0'>
              <div className='font-bold text-[16px] mb-[-15px] lg:mb-[10px]'>Social Media</div>
            ...
            <div className='min-w-[200px] h-auto flex flex-col items-center justify-start'>
              <div className='font-bold text-[16px] mb-[-15px] lg:mb-[10px]'>GitHub Repository</div>
              <a
